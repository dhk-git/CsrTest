...
namespace Csr.Components.Editor
{
    public class BlazingSummerJsInterop : IAsyncDisposable
    {
        private readonly Lazy<Task<IJSObjectReference>> _moduleTask;
        private readonly IJSObjectReference _moduleTask1;
        ...
        public BlazingSummerJsInterop(IJSRuntime jsRuntime, string id, EventHandler<string> onChange)
        {
            ...
            //_moduleTask1 = Task.Run(() => JsRuntime.InvokeAsync<IJSObjectReference>("import", "_content/Csr/SummernoteInterop.js")).Result;
            ...
            //_moduleTask = new Lazy<Task<IJSObjectReference>>(() =>
            //    JsRuntime.InvokeAsync<IJSObjectReference>("import",
            //        "./_content/Csr/js/SummernoteInterop.js").AsTask());
