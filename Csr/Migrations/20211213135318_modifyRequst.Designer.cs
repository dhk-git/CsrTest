...
namespace Csr.Migrations
{
    ...
    [Migration("20211213135318_modifyRequst")]
    partial class modifyRequst
    {
            ...
            modelBuilder.Entity("Csr.Models.CT_REQUEST", b =>
                {
                    ...
                    b.Property<string>("REQUEST_CONTENT")
            ...
            modelBuilder.Entity("Csr.Models.MD_USER", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            USER_ID = "admin",
                            CREATE_DTTM = new DateTime(2021, 12, 13, 22, 53, 17, 673, DateTimeKind.Local).AddTicks(2316),
                            CREATE_USER_ID = "A",
                            MODIFY_DTTM = new DateTime(2021, 12, 13, 22, 53, 17, 673, DateTimeKind.Local).AddTicks(2330),
                            MODIFY_USER_ID = "A",
                            USER_NM = "admin",
            ...
            modelBuilder.Entity("Csr.Models.SYS_CODE", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SYS_CD = "Question",
                            CREATE_DTTM = new DateTime(2021, 12, 13, 22, 53, 17, 673, DateTimeKind.Local).AddTicks(2644),
                            CREATE_USER_ID = "admin",
                            MODIFY_DTTM = new DateTime(2021, 12, 13, 22, 53, 17, 673, DateTimeKind.Local).AddTicks(2645),
                        ...
                        new
                        {
                            SYS_CD_GROUP = "REQUEST_TYPE",
                            SYS_CD = "ProgramError",
                            CREATE_DTTM = new DateTime(2021, 12, 13, 22, 53, 17, 673, DateTimeKind.Local).AddTicks(2669),
                            CREATE_USER_ID = "admin",
                            MODIFY_DTTM = new DateTime(2021, 12, 13, 22, 53, 17, 673, DateTimeKind.Local).AddTicks(2670),
                            MODIFY_USER_ID = "admin",
                            SORT_NO = 1m,
                            SYS_CD_NM = "프로그램오류"
                        },
                        new
                        {
                            SYS_CD_GROUP = "REQUEST_TYPE",
                            SYS_CD = "ModifyData",
                            CREATE_DTTM = new DateTime(2021, 12, 13, 22, 53, 17, 673, DateTimeKind.Local).AddTicks(2691),
                            CREATE_USER_ID = "admin",
                            MODIFY_DTTM = new DateTime(2021, 12, 13, 22, 53, 17, 673, DateTimeKind.Local).AddTicks(2692),
                            MODIFY_USER_ID = "admin",
                            SORT_NO = 1m,
                            SYS_CD_NM = "데이터수정"
                        });
            ...
            modelBuilder.Entity("Csr.Models.SYS_CODE_GROUP", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SYS_CD_GROUP = "REQUEST_TYPE",
                            CREATE_DTTM = new DateTime(2021, 12, 13, 22, 53, 17, 673, DateTimeKind.Local).AddTicks(2608),
                            CREATE_USER_ID = "admin",
                            MODIFY_DTTM = new DateTime(2021, 12, 13, 22, 53, 17, 673, DateTimeKind.Local).AddTicks(2610),
                            MODIFY_USER_ID = "admin",
                            SORT_NO = 1m,
