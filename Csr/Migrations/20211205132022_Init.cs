        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MD_USERUSER_ID = table.Column<string>(type: "varchar(20)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CT_REQUEST_MD_USER_MD_USERUSER_ID",
                        column: x => x.MD_USERUSER_ID,
                        principalTable: "MD_USER",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RESPONSE_ID = table.Column<int>(type: "int", nullable: false, comment: "답변ID")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    USER_ID1 = table.Column<string>(type: "varchar(20)", nullable: true),
                    ...
                    CT_REQUESTREQUEST_ID = table.Column<int>(type: "int", nullable: true),
                    REMARK = table.Column<string>(type: "nvarchar(200)", nullable: true, comment: "비고"),
                    CREATE_USER_ID = table.Column<string>(type: "varchar(20)", nullable: false, comment: "생성자"),
                    CREATE_DTTM = table.Column<DateTime>(type: "datetime", nullable: false, comment: "생성시간"),
                    MODIFY_USER_ID = table.Column<string>(type: "varchar(20)", nullable: false, comment: "수정자"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CT_RESPONSE_CT_REQUEST_CT_REQUESTREQUEST_ID",
                        column: x => x.CT_REQUESTREQUEST_ID,
                        principalTable: "CT_REQUEST",
                        principalColumn: "REQUEST_ID");
                    table.ForeignKey(
                        name: "FK_CT_RESPONSE_MD_USER_USER_ID1",
                        column: x => x.USER_ID1,
                        principalTable: "MD_USER",
                        principalColumn: "USER_ID");
                },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "admin", new DateTime(2021, 12, 5, 22, 20, 22, 197, DateTimeKind.Local).AddTicks(7768), "A", new DateTime(2021, 12, 5, 22, 20, 22, 197, DateTimeKind.Local).AddTicks(7777), "A", null, "admin", new byte[] { 97, 100, 109, 105, 110, 49 }, "Admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "REQUEST_TYPE", new DateTime(2021, 12, 5, 22, 20, 22, 197, DateTimeKind.Local).AddTicks(7867), "admin", new DateTime(2021, 12, 5, 22, 20, 22, 197, DateTimeKind.Local).AddTicks(7868), "admin", null, 1m, "요청유형" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "ModifyData", "REQUEST_TYPE", new DateTime(2021, 12, 5, 22, 20, 22, 197, DateTimeKind.Local).AddTicks(7896), "admin", new DateTime(2021, 12, 5, 22, 20, 22, 197, DateTimeKind.Local).AddTicks(7896), "admin", null, 1m, "데이터수정", null, null, null });

            migrationBuilder.InsertData(
                table: "SYS_CODE",
                columns: new[] { "SYS_CD", "SYS_CD_GROUP", "CREATE_DTTM", "CREATE_USER_ID", "MODIFY_DTTM", "MODIFY_USER_ID", "REMARK", "SORT_NO", "SYS_CD_NM", "VALUE_1", "VALUE_2", "VALUE_3" },
                values: new object[] { "ProgramError", "REQUEST_TYPE", new DateTime(2021, 12, 5, 22, 20, 22, 197, DateTimeKind.Local).AddTicks(7889), "admin", new DateTime(2021, 12, 5, 22, 20, 22, 197, DateTimeKind.Local).AddTicks(7889), "admin", null, 1m, "프로그램오류", null, null, null });

            migrationBuilder.InsertData(
                table: "SYS_CODE",
                columns: new[] { "SYS_CD", "SYS_CD_GROUP", "CREATE_DTTM", "CREATE_USER_ID", "MODIFY_DTTM", "MODIFY_USER_ID", "REMARK", "SORT_NO", "SYS_CD_NM", "VALUE_1", "VALUE_2", "VALUE_3" },
                values: new object[] { "Question", "REQUEST_TYPE", new DateTime(2021, 12, 5, 22, 20, 22, 197, DateTimeKind.Local).AddTicks(7880), "admin", new DateTime(2021, 12, 5, 22, 20, 22, 197, DateTimeKind.Local).AddTicks(7880), "admin", null, 1m, "단순문의", null, null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CT_REQUEST_MD_USERUSER_ID",
                table: "CT_REQUEST",
                column: "MD_USERUSER_ID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CT_RESPONSE_CT_REQUESTREQUEST_ID",
                table: "CT_RESPONSE",
                column: "CT_REQUESTREQUEST_ID");

            migrationBuilder.CreateIndex(
                name: "IX_CT_RESPONSE_USER_ID1",
                table: "CT_RESPONSE",
                column: "USER_ID1");
        }
